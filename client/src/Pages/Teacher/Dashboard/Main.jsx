  ...
  const [events, setEvents] = React.useState([
    {
      ...
      end: new Date(2023, 4, 10, 12, 0), // May 10th, 2023 at 12:00pm
    ...
    <>
        ...
        <div className='w-1/2'>
               <div className='flex drop-shadow-lg justify-between items-center py-4 px-10 bg-gray-50 border'>
                <div>
                  <h1 className='text-md font-bold text-black leading-loose border-b dark:border-slate-100'>Total Student</h1>
                  <p className='text-center leading-loose'>3</p>
                </div>
                <div>
                  <h1 className='text-md font-bold text-black leading-loose border-b dark:border-slate-100'>Total Teacher</h1>
                  <p className='text-center leading-loose'>3</p>
                </div>
                <div>
                ...
                <div>
                  <h1 className='text-md font-bold text-black leading-loose border-b dark:border-slate-100'>Earning</h1>
                  <p className='text-center leading-loose'>3</p>
                </div>
               </div>
               {/* order section */}
