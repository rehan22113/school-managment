...
import { Charts } from '../../../utils/library/Chart'
import { SaleChart } from '../../../utils/library/SaleChart'
import moment from 'moment'
import { SchoolFinanceChart } from '../../../utils/library/SchoolFinanceChart';
...
const Main = () => {
  const [events, setEvents] = React.useState([
    {
      start: new Date(2023, 4, 10, 10, 0), // May 10th, 2023 at 10:00am
      end: new Date(2023, 4, 11, 12, 0), // May 10th, 2023 at 12:00pm
    ...
    {
      start: new Date(2023, 4, 12, 14, 0), // May 12th, 2023 at 2:00pm
      end: new Date(2023, 4, 12, 15, 0), // May 12th, 2023 at 3:00pm
      title: 'Lunch with Sarah',
      description: 'Try out new restaurant'
    },
    {
      start: new Date(2023, 4, 14, 14, 0), // May 12th, 2023 at 2:00pm
      end: new Date(2023, 4, 16, 15, 0), // May 12th, 2023 at 3:00pm
      title: 'Lunch with Sarah',
      description: 'Try out new restaurant'
    },{
      start: new Date(2023, 4, 12, 14, 0), // May 12th, 2023 at 2:00pm
  ...
  return (
    <>
        ...
        <div className='w-1/2'>
               <div className='flex justify-around items-center py-4 bg-gray-50 space-x-2'>
                <div className='border py-4 px-2 md:w-40 drop-shadow-lg text-center flex items-center justify-between'>
               
                <div>
                  <h1 className='text-md font-bold text-black leading-loose border-b dark:border-slate-100'>Students</h1>
                  <p className='text-center leading-loose font-bold'>3</p>
                </div>
                <div>
                  <img src={StdImage} className='w-16' />
                </div>
                </div>
                <div className='border py-4 px-2 md:w-40 drop-shadow-lg text-center flex items-center justify-between'>
                <div>

                  <h1 className='text-md font-bold text-black leading-loose border-b dark:border-slate-100'>Teacher</h1>
                  <p className='text-center leading-loose font-bold'>3</p>
                </div>
                <div>
                  <img src={TeacherImage} className='w-16' />
                </div>
                </div>
                <div className='border py-4 px-2 md:w-40 drop-shadow-lg text-center flex items-center justify-between'>
                <div>

                  <h1 className='text-md font-bold text-black leading-loose border-b dark:border-slate-100'>Classes</h1>
                  <p className='text-center leading-loose'>3</p>
                </div>
                <div>
                <img src={ClassImage} className='w-16' />
                </div>
                </div>
                <div className='border py-4 px-2 md:w-40 drop-shadow-lg text-center flex items-center justify-between'>
                  <div>
                  <h1 className='text-md font-bold text-black leading-loose border-b dark:border-slate-100'>Event</h1>
                  <p className='text-center leading-loose'>3</p>
                  </div>
                  <div>
                <img src={EventImage} className='w-16' />
                </div>
                </div>
               ...
               <svg xmlns="http://www.w3.org/2000/svg" className='h-4' viewBox="0 0 576 512"><path d="M24 0C10.7 0 0 10.7 0 24S10.7 48 24 48H76.1l60.3 316.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24-10.7 24-24s-10.7-24-24-24H179.9l-9.1-48h317c14.3 0 26.9-9.5 30.8-23.3l54-192C578.3 52.3 563 32 541.8 32H122l-2.4-12.5C117.4 8.2 107.5 0 96 0H24zM176 512c26.5 0 48-21.5 48-48s-21.5-48-48-48s-48 21.5-48 48s21.5 48 48 48zm336-48c0-26.5-21.5-48-48-48s-48 21.5-48 48s21.5 48 48 48s48-21.5 48-48z" /></svg>
                <span className='font-extrabold'>Events and Activity Calender</span>
                </div>
               <Calendar 
                  localizer={localizer}
                  events={events}
               ...
               <svg xmlns="http://www.w3.org/2000/svg" className='h-4' viewBox="0 0 576 512"><path d="M24 0C10.7 0 0 10.7 0 24S10.7 48 24 48H76.1l60.3 316.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24-10.7 24-24s-10.7-24-24-24H179.9l-9.1-48h317c14.3 0 26.9-9.5 30.8-23.3l54-192C578.3 52.3 563 32 541.8 32H122l-2.4-12.5C117.4 8.2 107.5 0 96 0H24zM176 512c26.5 0 48-21.5 48-48s-21.5-48-48-48s-48 21.5-48 48s21.5 48 48 48zm336-48c0-26.5-21.5-48-48-48s-48 21.5-48 48s21.5 48 48 48s48-21.5 48-48z" /></svg>
                <span className='font-extrabold'>School Finance Report</span>
                </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className='h-4' viewBox="0 0 576 512"><path d="M64 32C28.7 32 0 60.7 0 96v32H576V96c0-35.3-28.7-64-64-64H64zM576 224H0V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V224zM112 352h64c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm112 16c0-8.8 7.2-16 16-16H368c8.8 0 16 7.2 16 16s-7.2 16-16 16H240c-8.8 0-16-7.2-16-16z" /></svg>
                ...
                <span className='font-extrabold'>School Performance</span>
                </div>
           <SaleChart />     
               </div>
               <div className='mt-5 drop-shadow-lg items-center py-4 px-10 bg-gray-50 border'>
