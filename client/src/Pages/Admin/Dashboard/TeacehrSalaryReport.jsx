...
{Products?.length >0 ? (
    ...
    return(
        ...
        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <img className="w-10 h-10 rounded-full" src="https://dummyimage.com/40x40" alt="Jese image" />
            <div className="pl-3 [&_div]:hover:flex">
                <div className=" text-base font-semibold">Richard Dawken</div>
                <div className="group font-normal text-gray-500 hover:flex space-x-2 hidden">
                    ...
                    <a target="_blank" href={`#`} className='underline cursor-pointer hover:text-blue-600'>View</a>
            ...
            <td className="py-4 px-6">
            <div className="flex items-center">
                <div className=" p-1 bg-green-400 mr-2 text-white" > Paid</div>
            </div>
            </td>
            <td className="py-4 px-6">
            10/05/2023
   ...
   <div className='flex'>
        <div className='px-10 w-full flex flex-col justify-center items-center'>
            ...
            <h1 className='py-10 text-xl uppercase'>No Record To Display</h1>
        </div>
   </div>
   </>
   )
...
export default TeacehrSalaryReport